...
<div class="x_panel">
        ...
        <div class="x_content">
        	<form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" id="demo-form2" action="{{ route('assembly.store') }}">
                {{ csrf_field() }}
                                ...
                                <ul>
                                    <li>
                                        <div class="radio-group">	
                                            <input type="radio" name="sex" class="donthaveclass priority" id="male" value="male">
                ...
                {{-- <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <select class="form-control" name="state">
                            	...
                            	<option value="2">@lang('pages.assembly.dropdown.state_2')</option>
                            </select>
                        </div>
                </div> --}}
                ...
                <div class="form-footer">
                    <div class="form-group">
                        <div class="submit-btn col-md-6 col-md-offset-3 col-sm-offset-3">
                            <button type="submit"  class="btn btn-success submitBtn">@lang('pages.assembly.save_assembly') <span class="loading hide"><i class="fa fa-spinner fa-spin"></i></span></button>
