        	...
        	<form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" id="demo-form2" action="{{ route('assembly.update', '1') }}">
        		...
        		<div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                           <input type="text" name="name" class="form-control" value="Dinesh Karki">
                        </div>
                </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                           <input type="text" name="designation" class="form-control" value="CEO">
                        </div>
                </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                           <input type="text" name="mobile" class="form-control" value="9841764628">
                        </div>
                </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                           <input type="text" name="email" class="form-control" value="dinesh@3hammers.com">
                        </div>
                </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <select class="form-control sumoSelect">
                                        ...
                                        <option value="6" selected>Gorkha</option>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <select class="form-control sumoSelect">
                                        ...
                                        <option value="10" selected>Ward No 10</option>
