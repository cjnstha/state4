        	...
        	<form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" id="demo-form2" action="{{ route('assembly.update', '1') }}">
        		...
        		<div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                           <input type="text" name="name" class="form-control" value="Laxmi Adhikari">
                        </div>
                </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                           <input type="text" name="designation" class="form-control" value="Deputy Mayor">
                        </div>
                </div>
                        ...
                        @lang('pages.numbers.3'). @lang('pages.assembly.sex')
                       	...
                       	<div class="radio-wrap">
                                <ul>
                                    ...
                                    <li>
                                        <div class="radio-group">
                                            <input type="radio" name="sex" class="donthaveclass priority" id="female" value="female" checked>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                           <input type="text" name="mobile" class="form-control" value="9856046511">
                        </div>
                </div>
