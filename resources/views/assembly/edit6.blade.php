        	...
        	<form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" id="demo-form2" action="{{ route('assembly.update', '1') }}">
        		...
        		<div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                           <input type="text" name="name" class="form-control" value="Bhim Prasad Tiwari">
                        </div>
                </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                           <input type="text" name="designation" class="form-control" value="Chief Administrative Officer">
                        </div>
                </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                           <input type="text" name="mobile" class="form-control" value="9856009111">
                        </div>
                </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                           <input type="text" name="email" class="form-control" value="bptiwari45@gmail.com">
                        </div>
                </div>
