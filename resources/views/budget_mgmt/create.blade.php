...
<div class="x_panel">
        ...
        <div class="x_content">
        	<form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" id="demo-form2" action="{{ route('budget.store')}}">
        		{{ csrf_field() }}
                ...
                <div class="form-group">
                	...
                	<div class="col-md-6 col-sm-7 col-xs-12">
                		<input type="number" name="budget" min="0" class="form-control">
                	</div>
                </div>
                ...
                <div class="form-footer">
                    <div class="form-group">
                        <div class="submit-btn col-md-6 col-md-offset-3 col-sm-offset-3">
                            <button type="submit"  class="btn btn-success submitBtn">@lang('pages.budget_mgmt.save_budget') <span class="loading hide"><i class="fa fa-spinner fa-spin"></i></span></button>
