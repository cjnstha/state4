        	...
        	<div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <select class="form-control" name="project_id">
                                ...
                                <option value="1" selected>Project 1</option>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <input type="text" name="project_type" class="form-control" value="Construction">
                        </div>
                </div>
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            ...
                            <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select name="municipality_id" class="form-control">
                                            <option value="">--Select--</option>
                                            <option value="1" selected>Kirtipur</option>
                            ...
                            <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address" class="form-control" value="Samakhusi">
                                    </div>
                            </div>
                            </div>
                        </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <input type="number" name="budget" class="form-control" value="999999">
                        </div>
                </div> 
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <input type="text" name="status" class="form-control" value="Ongoing">
                        </div>
                </div>  
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <input type="number" name="expense" class="form-control" value="1234">
                        </div>
                </div>
                ...
                <div class="form-footer">
                    <div class="form-group">
                        <div class="submit-btn col-md-6 col-md-offset-3 col-sm-offset-3">
                            ...
                            <a href="{{ route('budget_report.index') }}" class="btn btn-danger">@lang('pages.labels.cancel')</a>
                        </div>
                    </div>
                </div>
