...
<div class="x_panel">
        <div class="x_title">
            <h2>@lang('pages.citizen_charter.update_citizen_charter')</h2>
            <div class="clearfix"></div>
        </div>
        <div class="x_content">
        	<form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" id="demo-form2" action="{{route('citizen.update', 1)}}">
                {{ csrf_field() }}
                ...
                <div class="form-footer">
                    <div class="form-group">
                        <div class="submit-btn col-md-6 col-md-offset-3 col-sm-offset-3">
                            <button type="submit"  class="btn btn-success submitBtn">@lang('pages.citizen_charter.update_citizen_charter') <span class="loading hide"><i class="fa fa-spinner fa-spin"></i></span></button>
