...
<div class="x_panel">
        ...
        <div class="x_content">
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="project_brief" class="form-control" rows="5" cols="5"></textarea>
                                    </div>
                                </div>
                            </div>
            ...
            <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" id="demo-form2" action="{{ route('contractor.store') }}">
                {{ csrf_field() }}
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            ...
                            <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <fieldset>
                                            <div class="control-group">
                                                <div class="controls">
                                                        <input type="text" name="established" class="form-control col-md-7 col-xs-12" id="datepick-all">
                                                </div>
                                            </div>
                                        </fieldset>
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="c_person2" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="checkbox checkbox-primary">
                                                ...
                                                <input id="building_construction" type="checkbox" name="building" value="1">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="checkbox checkbox-primary">
                                                ...
                                                <input id="bridge_construction" type="checkbox" name="bridge" value="2">
                            ...
                            <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <fieldset>
                                            <div class="control-group">
                                                <div class="controls">
                                                        <input type="text" name="end_date" class="form-control col-md-7 col-xs-12" id="datepick-all">
                                                </div>
                                            </div>
                                        </fieldset>     
                                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <select class="form-control" name="p_performance">
                                <option selected value="">@lang('pages.labels.dropdown_select')</option>
                                <option value="1">@lang('pages.contractor_management.dropdown.below_average')</option>
                                <option value="2">@lang('pages.contractor_management.dropdown.average')</option>
                ...
                <div class="form-footer">
                    <div class="form-group">
                        <div class="submit-btn col-md-6 col-md-offset-3 col-sm-offset-3">
                            <button type="submit"  class="btn btn-success submitBtn">@lang('pages.contractor_management.save_contractor') <span class="loading hide"><i class="fa fa-spinner fa-spin"></i></span></button>
