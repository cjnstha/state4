@extends('layouts.master')
    @section('content')
        ...
        <div class="x_panel">
            ...
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{ route('currency.update', $data->id)}}" method="post">
                    {{ csrf_field() }} 
                    ...
                    <div class="form-group">
                        ...
                        <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <input type="text" name="symbol" class="form-control" required="" value="{{ $data['symbol'] }}">
                        </div>
                    </div>
