...
<div class="x_panel">
        ...
        <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" id="demo-form2" action="{{ route('decision_progress.store') }}">
            {{ csrf_field() }}
        	<div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <textarea class="form-control" name="decision" rows="5"></textarea>
                        </div>
            </div>
            ...
            <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <textarea class="form-control" name="progress" rows="5"></textarea>
                        </div>
            </div>
            ...
            <div class="form-footer">
                    <div class="form-group">
                        <div class="submit-btn col-md-6 col-md-offset-3 col-sm-offset-3">
                            <button type="submit"  class="btn btn-success submitBtn">@lang('pages.decision_progress.save_dvp') <span class="loading hide"><i class="fa fa-spinner fa-spin"></i></span></button>
