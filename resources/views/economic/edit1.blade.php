...
<div class="x_panel">
        <div class="x_title">
            <h2>@lang('pages.economic.update_economic')</h2>
            <div class="clearfix"></div>
        </div>
        <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" id="demo-form2" action="{{route('eco.update','1')}}">
            {{ csrf_field() }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="total" class="form-control" value="3.40"> 
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="year" class="form-control" value="3.40"> 
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="year" class="form-control" value="1.99"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="year" class="form-control" value="1.45"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="total" class="form-control" value="2.1"> 
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="year" class="form-control" value="1000"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="total" class="form-control" value="2000"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                 ...
                                 <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="total" class="form-control" value="1000"> 
                                    </div>
                                </div>
                                 ...
                                 <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="total" class="form-control" value="5000"> 
                                    </div>
                                </div>
                                 ...
                                 <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="total" class="form-control" value="4000"> 
                                    </div>
                                </div>
                                 ...
                                 <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="total" class="form-control" value="6000"> 
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="year" class="form-control" value="10000"> 
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="total" class="form-control" value="7000"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="total" class="form-control" value="3000"> 
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="form-footer">
                    <div class="form-group">
                        <div class="submit-btn col-md-6 col-md-offset-3 col-sm-offset-3">
                            <button type="submit"  class="btn btn-success submitBtn">@lang('pages.economic.update_economic') <span class="loading hide"><i class="fa fa-spinner fa-spin"></i></span></button>
