...
<div class="x_panel">
        <div class="x_title">
            <h2>@lang('pages.education.update_education')</h2>
            <div class="clearfix"></div>
        </div>
        <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" id="demo-form2" action="{{ route('education.update','1') }}">
            {{ csrf_field() }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="total" class="form-control" value="46"> 
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="year" class="form-control" value="700"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="total" class="form-control" value="700"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="year" class="form-control" value="100"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="year" class="form-control" value="310"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="total" class="form-control" value="80"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                 ...
                                 <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="year" class="form-control" value="150"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                 ...
                                 <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="year" class="form-control" value="400"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                 ...
                                 <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="year" class="form-control" value="80"> 
                                    </div>
                                </div>
             ...
             <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="control-label">@lang('pages.education.institutional')</label>
                                        <input type="number" name="total" class="form-control" value="50"> 
                                    </div>
                                </div>
...
<div class="form-footer">
                    <div class="form-group">
                        <div class="submit-btn col-md-6 col-md-offset-3 col-sm-offset-3">
                            <button type="submit"  class="btn btn-success submitBtn">@lang('pages.education.update_education') <span class="loading hide"><i class="fa fa-spinner fa-spin"></i></span></button>
