...
<div class="x_panel">
        ...
        <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" id="demo-form2" action="{{ route('household.store') }}">
            {{ csrf_field() }}
                            ...
                            <div class="row">
                            	<div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="access_drink" class="form-control"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                	<div class="form-group">
                                        ...
                                        <input type="number" name="no_access_drink" class="form-control"> 
                                    </div>
                                </div>
                            </div>
                        </div>    	
                    ...
                    <div class="row">
                        <div class="col-md-4 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="pipe" class="form-control"> 
                                </div>
                        </div>
                        ...
                        <div class="col-md-4 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="tube" class="form-control"> 
                                </div>
                        </div>
                        ...
                        <div class="col-md-4 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="spout" class="form-control"> 
                                </div>
                        </div>
                        ...
                        <div class="col-md-4 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="u_well" class="form-control"> 
                                </div>
                        </div>
                        ...
                        <div class="col-md-4 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="c_well" class="form-control"> 
                                </div>
                        </div>
                        ...
                        <div class="col-md-4 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="river" class="form-control"> 
                                </div>
                        </div>
                        ...
                        <div class="col-md-4 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="not_stated" class="form-control"> 
                                </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                            	<div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="flush" class="form-control"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                	<div class="form-group">
                                        ...
                                        <input type="number" name="ordinary" class="form-control"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="no_toilet" class="form-control"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                	<div class="form-group">
                                        <label class="control-label">@lang('pages.household.not_stated')</label>
                                        <input type="number" name="not_stated_toilet" class="form-control"> 
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                            	<div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="elec_access" class="form-control"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                	<div class="form-group">
                                        ...
                                        <input type="number" name="no_elec_access" class="form-control"> 
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="form-footer">
                    <div class="form-group">
                        <div class="submit-btn col-md-6 col-md-offset-3 col-sm-offset-3">
                            <button type="submit"  class="btn btn-success submitBtn">@lang('pages.household.save_household')<span class="loading hide"><i class="fa fa-spinner fa-spin"></i></span></button>
