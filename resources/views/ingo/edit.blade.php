                ...
                {{Form::model($ingo, ['route'=>['ingo.update', $ingo->id], 'id'=>'demo-form2', 'class'=>'form-horizontal', 'data-parsley-validate', 'method'=>'patch'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            {{Form::text('name', $ingo->name, ['class'=>'form-control col-md-7 col-xs-12','required','required'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <select name="country" required  class="form-control sumoSelect">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            {{Form::text('address', $ingo->address, ['class'=>'form-control col-md-7 col-xs-12','required'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            {{Form::email('email', $ingo->email, ['class'=>'form-control col-md-7 col-xs-12','required'])}}
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <fieldset>
                                <div class="control-group">
                                    <div class="controls">
                                        {{Form::text('estd_date', $ingo->estd_date, ['class'=>'form-control has-feedback-left col-md-7 col-xs-12', 'id'=>'datepick-all','required'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <fieldset>
                                <div class="control-group">
                                    <div class="controls">
                                        {{Form::text('close_date', $ingo->close_date, ['class'=>'form-control has-feedback-left col-md-7 col-xs-12', 'id'=>'datepick-all','required'])}}
                                            <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                                    </div>
                                </div>
                            </fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            {{Form::number('staff_number', $ingo->staff_number, ['class'=>'form-control col-md-7 col-xs-12','required'])}}
                        </div>
                    </div>
