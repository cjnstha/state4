@extends('layouts.master')
    @section('content')
        ...
        <div class="x_panel">
            <div class="x_title">
                <h2>Edit Logical Framework</h2>
                <div class="clearfix"></div>
            </div>
            
            <div class="x_content">
                {{Form::model($posts, ['route'=>['logical.update', $posts->id], 'id'=>'demo-form2', 'class'=>'form-grid','method'=>'patch', 'data-parsley-validate','files'=> 'true'])}}
                {{-- <form id="demo-form2" data-parsley-validate class="form-grid" action="{!! route('trainings.store') !!} " method="post">
                    {{ csrf_field() }} --}}
                    <div class="form-group">
                        
                        <div class="col-md-6 col-sm-7 col-xs-12">
                        {!! Form::hidden('goal', null ,['class' => 'form-control','required'] ) !!}
                        </div>
                    </div> 
