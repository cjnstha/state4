@extends('layouts.master')
    @section('content')
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                {{Form::model($posts, ['route'=>['misc-district.update', $posts->id], 'id'=>'demo-form2', 'class'=>'form-horizontal form-label-left','method'=>'patch', 'data-parsley-validate'])}}
                {{-- <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{!! route('trainings.store') !!} " method="post">
                    ...
                    <div class="form-group">
                        ...
                        <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-7 col-xs-12">
                        {!! Form::text('cbs_code', null ,['class' => 'form-control'] ) !!}
                        </div>
                    </div>
                        ...
                        <div class="form-footer">
                            <div class="form-group">
                                <div class="submit-btn col-md-6 col-md-offset-3 col-sm-offset-3">
                                    ...
                                    <a href="{{ route('misc-district.index') }}" class="btn btn-danger">Cancel</a>
                                </div>
                            </div>
                        </div>
                {{-- </form> --}}
