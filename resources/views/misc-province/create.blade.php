@extends('layouts.master')
    @section('content')
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                {{Form::open(['route'=>'misc-province.store', 'id'=>'demo-form2', 'class'=>'form-horizontal form-label-left', 'data-parsley-validate', 'files'=>'true'])}}
                    ...
                    <div class="form-footer">
                        <div class="form-group">
                            <div class="submit-btn col-md-6 col-md-offset-3 col-sm-offset-3">
                                ...
                                <a href="{{ route('misc-province.index') }}" class="cancel-button">Cancel</a>
                            </div>
                        </div>
                    </div>
