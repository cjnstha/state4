        ...
        <form class="form-horizontal form-label-left" method="get" enctype="multipart/form-data" id="demo-form2" action="">
        	<div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            ...
                            <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address" class="form-control" value="Baluwatar">
                                    </div>
                            </div>
                            </div>
                        </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <input type="number" name="budget" class="form-control" value="100000">
                        </div>
                </div> 
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <input type="number" name="expense" class="form-control" value="9999">
                        </div>
                </div>
