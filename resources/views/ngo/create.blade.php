@extends('layouts.master')
    @section('content')
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                {{Form::open(['route'=>'ngo.store', 'id'=>'demo-form2', 'class'=>'form-grid', 'data-parsley-validate'])}}
                        ...
                        <div class="col-md-8 col-sm-7 col-xs-12">
                            <fieldset>
                                <div class="control-group">
                                    <div class="controls">
                                        {{Form::text('established_date', null, ['class'=>'form-control has-feedback-left col-md-7 col-xs-12', 'id'=>'datepick-all'])}}
