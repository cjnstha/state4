...
<div class="x_panel">
        ...
        <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" id="demo-form2" action="{{ route('ngoingo.update', '1')}}">
            {{csrf_field()}}
        	...
        	<div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <input type="text" name="name" class="form-control" value="CSO 123">
                        </div>
                </div>
                ...
                <div class="form-group">
                        ...
                        <fieldset>
                            <div class="control-group">
                                <div class="controls">
                                    <input type="text" name="register_date" class="form-control col-md-7 col-xs-12" id="datepick-all" value="2018-10-28">
                                </div>
                            </div>
                        </fieldset>
                    </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <select name="category" class="form-control sumoSelect">
                                <option value=""></option>
                                <option value="1" selected>NGO</option>
                 ...
                 <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <input type="text" name="pan" class="form-control" value="78-567-1234">
                        </div>
                </div> 
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <select name="fow" class="form-control sumoSelect" multiple="">
                                ...
                                <option value="2" selected>@lang('pages.ngo_ingo.agriculture')</option>
                            ...
                            <div class="col-md-4 col-sm-12">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="c_1" class="form-control" value="Tole 2">
                                    </div>
                                </div>
                            </div>
                        </div>
				...
				<div class="form-footer">
                    <div class="form-group">
                        <div class="submit-btn col-md-6 col-md-offset-3 col-sm-offset-3">
                            <button type="submit"  class="btn btn-success submitBtn">@lang('pages.ngo_ingo.update_ngo_ingo') <span class="loading hide"><i class="fa fa-spinner fa-spin"></i></span></button>
