    ...
    @section('content')
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                {{Form::open(['route'=>'plan.store', 'id'=>'demo-form2', 'class'=>'form-horizontal form-label-left', 'data-parsley-validate'])}}
                ...
                <div class="x_panel x_panel-box">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12"> Goal <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-7 col-xs-12">
