                ...
                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                    <div class="panel panel-default">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                            <div class="panel-body">
                                <form  method="POST" action="javascript:;" class="form-grid-v2 FilterForm" data-base="plan" data-filter="filter">
                                    {{ csrf_field() }}
                                    <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse " role="tabpanel" aria-labelledby="headingTwo">
                            <div class="panel-body">
                                <form  method="POST" action="javascript:;" id="filter-search-plan2" class="form-grid-v2">
                                    {{ csrf_field() }}
                                    <div class="row">
                                            <div class="col-md-4 col-xs-12 col-sm-4">
                                                <div class="form-group">
                ...
                <table id="datatable-table-index" class="table table-striped table-bordered">
                    ...
                    <tr>
                       <td> {{ $i }}</td>
                        ...
                        <td> {{ $p->activities->name }}</td>              
                        <td>
                            
                            @php
                             $date = $p->p_date;
                             $plandate = strtotime($date);
                            
                            @endphp 

                        {{ date(' F jS, Y',$plandate) }}
                        ...
                        <td>
                            ...
                            <a href=" {{ route('plan.edit',$p->id) }}" class="action-btns">
                                <span class="glyphicon glyphicon-pencil"></span>
                            </a>
                            {{Form::open(['route'=>['plan.destroy', $p->id] , 'method'=>'DELETE', 'class'=>'form-inline' ])}}
