        ...
        <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" id="demo-form2" action="{{ route('policy.update','1') }}">
            {{ csrf_field() }}
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <input type="text" name="project_code" class="form-control" value="MGD001">
                        </div>
                </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <input type="text" name="project_name" class="form-control" value="Facilities to improve tourist accomodation in the region">
                        </div>
                </div>
                        ...
                        <div class="row">                      
                            <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <option value="5" selected>Kaski</option>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="control-label">@lang('pages.policy_mgmt.type_cost')</label>
                                        <input type="text" name="type_of_cost" class="form-control" value="Research">
                                    </div>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="control-label">@lang('pages.policy_mgmt.cost')</label>
                                        <input type="text" name="cost" class="form-control" value="100000">
                                    </div>
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            ...
                            <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select name="contractor_id" class="form-control">
                                            <option value="">--Select--</option>
                                            <option value="1" selected>Contractor A</option>
            ...
            <div class="form-group">
                ...
                <div class="radio-wrap">
                    <ul>
                        <li>
                            <div class="radio-group">
                                <input type="radio" name="national" class="donthaveclass national" id="yess" value="yes" checked>
