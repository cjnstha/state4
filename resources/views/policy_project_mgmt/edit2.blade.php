        ...
        <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" id="demo-form2" action="{{ route('policy.update','1') }}">
            {{ csrf_field() }}
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <input type="text" name="project_code" class="form-control" value="BSM001">
                        </div>
                </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <input type="text" name="project_name" class="form-control" value="Sera Buspark Construction">
                        </div>
                </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="control-label">@lang('pages.policy_mgmt.type_cost')</label>
                                        <input type="text" name="type_of_cost" class="form-control" value="Construction">
                                    </div>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="control-label">@lang('pages.policy_mgmt.cost')</label>
                                        <input type="text" name="cost" class="form-control" value="4200000">
                                    </div>
                            </div>
                            </div>
                        </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            ...
                            <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select name="contractor_id" class="form-control">
                                            ...
                                            <option value="2" selected>Contractor B</option>
                            ...
                            <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label class="control-label">@lang('pages.policy_mgmt.contractor_budget')</label>
                                        <input type="text" name="contract_budget" class="form-control" value="3500000">
                                    </div>
                            </div>
                            </div>
