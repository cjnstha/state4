...
<div class="x_panel">
        <div class="x_title">
            <h2>@lang('pages.policy_mgmt.update_project')</h2>
        ...
        <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" id="demo-form2" action="{{ route('policy.update','1') }}">
            {{ csrf_field() }}
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <input type="text" name="project_fiscal" class="form-control" value="2074/2075">
                        </div>
                </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <input type="text" name="project_code" class="form-control" value="BSM002">
                        </div>
                </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <input type="text" name="project_name" class="form-control" value="Black topping of road from Highschool avenue till Ringroad junction">
                        </div>
                </div>
                        ...
                        <div class="row">                      
                            <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <option value="6" selected>Lamjung</option>
                ...
                <div class="form-group">
                        ...
                        <fieldset>
                            <div class="control-group">
                                <div class="controls">
                                    <input type="text" name="start_date" class="form-control col-md-7 col-xs-12" id="datepick-all" value="2018-09-11">
                                </div>
                            </div>
                        </fieldset>
                    </div>
                ...
                <div class="form-group">
                        ...
                        <fieldset>
                            <div class="control-group">
                                <div class="controls">
                                    <input type="text" name="deadline" class="form-control col-md-7 col-xs-12" id="datepick-all" value="2019-09-11">
                                </div>
                            </div>
                        </fieldset>
                    </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="control-label">@lang('pages.policy_mgmt.type_cost')</label>
                                        <input type="text" name="type_of_cost" class="form-control" value="Road Repairment">
                                    </div>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="control-label">@lang('pages.policy_mgmt.cost')</label>
                                        <input type="text" name="cost" class="form-control" value="2500000">
                                    </div>
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            ...
                            <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select name="contractor_id" class="form-control">
                                        	<option value="">--Select--</option>
                                        	<option value="1" selected="">Lakshya Maharjan</option>
                                        	<option value="2">Yojan Shrestha</option>
                                        	<option value="3">Sajina Makaju</option>
                                        	<option value="4">Neha Khadka</option>
                                        	<option value="5">Pranit Bhatta</option>
                                        </select>
                                    </div>
                            </div>
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="contract_budget" class="form-control" value="10000">
                                    </div>
                            </div>
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <fieldset>
                                            <div class="control-group">
                                                <div class="controls">
                                                        <input type="text" name="signed_date" class="form-control col-md-7 col-xs-12" id="datepick-all" value="2018-08-12">
                                                </div>
                                            </div>
                                        </fieldset>     
                                    </div>
                            ...
                            <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <fieldset>
                                            <div class="control-group">
                                                <div class="controls">
                                                        <input type="text" name="completion_date" class="form-control col-md-7 col-xs-12" id="datepick-all" value="2019-05-11">
                                                </div>
                                            </div>
                                        </fieldset>     
                                    </div>
                            ...
                            <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select name="project_stattus" class="form-control status">
                                        	<option value="">--Select--</option>
                                        	<option value="1" selected>Yet To Start</option>
                            ...
                            <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="completion_review" rows="5">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</textarea>
                                    </div>
                            </div>
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label class="control-label">@lang('pages.policy_mgmt.remark')</label>
                                        <textarea class="form-control" name="remark" rows="5">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. </textarea>
                                    </div>
                            </div>
                            </div>
                                ...
                                <ul>
                                    <li>
                                        <div class="radio-group">	
                                            <input type="radio" name="qow" class="donthaveclass" id="radio-1" value="very_good" checked>
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <ul>
                                    <li>
                                        <div class="radio-group">	
                                            <input type="radio" name="delivery" class="donthaveclass" id="timely_delivery-1" value="very_good" checked>
                            ...
                            <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        <label class="control-label">@lang('pages.policy_mgmt.payment_detail')</label>
                                        <input type="text" name="c_person1" class="form-control" value="First Down Payment">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        <label class="control-label">@lang('pages.policy_mgmt.amount')</label>
                                        <input type="text" name="designation1" class="form-control" value="999">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <fieldset>
                                            <div class="control-group">
                                                <div class="controls">
                                                        <input type="text" name="completion_date" class="form-control col-md-7 col-xs-12" id="datepick-all" value="2018-12-12">
                                                </div>
                                            </div>
                                        </fieldset> 
                                    </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            ...
                            <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select name="contractor_id" class="form-control">
                                            ...
                                            <option value="3" selected>Contractor C</option>
                            ...
                            <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label class="control-label">@lang('pages.policy_mgmt.contractor_budget')</label>
                                        <input type="text" name="contract_budget" class="form-control" value="2000000">
                                    </div>
                            </div>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            ...
                            <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label class="control-label">@lang('pages.policy_mgmt.completion_review')</label>
                                        <textarea class="form-control" name="completion_review" rows="5">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <select name="amend" class="form-control" id="amended">
                            	...
                            	<option value="2" selected>@lang('pages.policy_mgmt.no')</option>
                            </select>
                        </div>
                        ...
                        @lang('pages.numbers.1')@lang('pages.numbers.2'). @lang('pages.policy_mgmt.priority_project')
                       	...
                       	<div class="radio-wrap">
                                <ul>
                                    ...
                                    <li>
                                        <div class="radio-group">
                                            <input type="radio" name="priority" class="donthaveclass priority" id="no" value="no" checked>
            ...
            <div class="form-group">
                ...
                <div class="radio-wrap">
                    <ul>
                        ...
                        <li>
                            <div class="radio-group">
                                <input type="radio" name="national" class="donthaveclass national" id="noo" value="no" checked>
				...
				<div class="form-footer">
                    <div class="form-group">
                        <div class="submit-btn col-md-6 col-md-offset-3 col-sm-offset-3">
                            <button type="submit"  class="btn btn-success submitBtn">@lang('pages.policy_mgmt.update_project') <span class="loading hide"><i class="fa fa-spinner fa-spin"></i></span></button>
