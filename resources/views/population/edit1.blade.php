...
<div class="x_panel">
        ...
        <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" id="demo-form2" action="{{ route('population.update', '1') }}">
            {{ csrf_field() }}
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="total_pop" class="form-control" value="10000"> 
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="male" class="form-control" value="6000"> 
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="control-label">@lang('pages.population.female')</label>
                                        <input type="number" name="female" class="form-control" value="4000"> 
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="median" class="form-control" value="30"> 
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="control-label">@lang('pages.population.youth')</label>
                                        <input type="number" name="age_0_14" class="form-control" value="2000"> 
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="age_15_60" class="form-control" value="6000"> 
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="control-label">@lang('pages.population.aged')</label>
                                        <input type="number" name="age_60_above" class="form-control" value="2000"> 
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            ...
                            <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="c_1" class="form-control" value="2000">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
										...
										<input type="number" name="c_2" class="form-control" value="2000">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="c_3" class="form-control" value="2000"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="c_4" class="form-control" value="2000"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="c_5" class="form-control" value="2000"> 
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            ...
                            <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="c_1" class="form-control" value="100">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="c_2" class="form-control" value="200">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="c_3" class="form-control" value="50"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="c_4" class="form-control" value="10"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="c_5" class="form-control" value="25"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="c_6" class="form-control" value="60"> 
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="c_7" class="form-control" value="5"> 
                                    </div>
                                </div>
            ...
            <div class="form-footer">
                    <div class="form-group">
                        <div class="submit-btn col-md-6 col-md-offset-3 col-sm-offset-3">
                            <button type="submit"  class="btn btn-success submitBtn">@lang('pages.population.update_population') <span class="loading hide"><i class="fa fa-spinner fa-spin"></i></span></button>
