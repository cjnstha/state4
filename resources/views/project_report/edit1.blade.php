...
<div class="x_panel">
        <div class="x_title">
            <h2>@lang('pages.municipality_report.update_report')</h2>
        ...
        <form class="form-horizontal form-label-left" method="get" enctype="multipart/form-data" id="demo-form2" action="">
        	<div class="form-group">
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <input type="number" name="budget" class="form-control"  value="12346789">
                        </div>
                </div> 
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <input type="number" name="expense" class="form-control" value="123456">
                        </div>
                </div>
                ...
                <div class="form-footer">
                    <div class="form-group">
                        <div class="submit-btn col-md-6 col-md-offset-3 col-sm-offset-3">
                            ...
                            <a href="{{ route('report_project.index') }}" class="btn btn-danger">@lang('pages.labels.cancel')</a>
                        </div>
                    </div>
                </div>
