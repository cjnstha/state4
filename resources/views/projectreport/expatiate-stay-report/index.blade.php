    ...
    <div class="col-md-12 col-sm-12 col-xs-12"> 
         ...
         <div class="x_panel filter">
            ...
            <div class="x_content bg-gray no-search">
                ...
                <form method="POST" action="javascript:;" class="form-grid-v2 filterReportForm" data-report="expatiate-stay-report" data-filter="filter" >
                     {{ csrf_field() }}
                    <div class="row">
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="">
                                    {{ Form::select('project_name', $projects, null, ['class'=>'form-control sumoSelect', 'placeholder'=>'--Select Here--'])}}
                                </div>
                            </div>
                        </div>
