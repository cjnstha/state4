    ...
    <div class="col-md-12 col-sm-12 col-xs-12"> 
         ...
         <div class="x_panel filter">
            ...
            <div class="x_content bg-gray no-search">
                ...
                <form method="POST" action="javascript:;" class="form-grid-v2 filterReportForm" data-report="thematic-activity-search" data-filter="filter" >
                     {{ csrf_field() }}
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="">
                                    <select name="ward[]" class="form-control sumoSelect" multiple placeholder="--Select Here--">
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-4">
                            <div class="form-group">
                                <label for="" class="control-label">Thematic</label>
                                <div class="">
                                    {{ Form::select('theme[]', $themes ,null, ['class' => 'form-control sumoSelect','multiple']) }}
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-xs-12 col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="">
                                    {{ Form::select('activity[]', $activitys ,null, ['class' => 'form-control sumoSelect','multiple']) }}
                                </div>
                            </div>
                        </div>
                    </div>
