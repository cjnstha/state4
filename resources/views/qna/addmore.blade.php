...
{{Form::open(['route'=>'qna-postmore', 'id'=>'demo-form2', 'class'=>'form-horizontal form-label-left', 'id'=>'uploadForm', 'data-parsley-validate', 'files'=> 'true'])}}

{{ Form::hidden('question_set_id', $question_set_id) }}
            ...
            <div class="panel-body">
                <div class="title-input-filed">
                    <div class="form-group">
                        ...
                        {{Form::hidden('question_set_name', $question_set_name)}}
                        </div>
                    </div>
                </div>
                ...
                <div class="repeat-block-wrap">
                    <div class="input-field-group">
                      <div class="repeatdiv">
                          ...
                          <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12">Answer Type
                              <span class="required">*</span></label>
                              <div class="col-md-6 col-sm-7 col-xs-12">
                          ...
                          <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12">Answer Option
                              <span class="required">*</span></label>
                              <div class="col-md-6 col-sm-7 col-xs-12">
                    ...
                    <div class="addmore col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
                        <a href="javascript:;" class="addmorebtn_qna btn btn-default btn-sm">
                          <i class="fa fa-plus"></i> Add New Question/Answer
                        </a>
                    </div>
