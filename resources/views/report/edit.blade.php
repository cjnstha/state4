@extends('layouts.master')
    @section('content')
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                {{Form::model($report, ['route'=>['report.update', $report->id], 'id'=>'demo-form2', 'class'=>'form-horizontal form-label-left', 'data-parsley-validate', 'method'=>'patch', 'files'=> 'true'])}}
          ...
          <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Type of Report <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-7 col-xs-12">
                        {{ Form::select('type', [
                                    ''  => '--Select--',
                                   'QPR' => 'QPR',
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                        {{Form::text('approve_by', null, ['class'=>'form-control col-md-7 col-xs-12','required'])}}
                        </div>
                </div>
