                            ...
                            <div class="preview-logo-wrap">
                                ...
                                @if(!empty($setting->logo))
                                    <div class="preview-logo" id="img-preview">
                                        <img class="img-center" src="{{url('images/logo/'.$setting->logo)}}"  alt = "image preview" title="image preview">
                                    </div>
                                @endif
                            </div>
                        ...
                        <div class="col-md-6 col-sm-7 col-xs-12">
                            <div class="preview-logo-wrap favicon">
                                ...
                                @if(!empty($setting->favicon))
                                    <div class="preview-logo" id="img-preview2">
                                        <img class=""  src="{{url('images/logo/favicon/'.$setting->favicon)}}" alt = "image preview" title="image preview">
                                    </div>
                                @endif
                            </div>
                            <div class="browse input-group image-browse-btn">
