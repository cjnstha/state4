...
@section('content')
                ...
                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                    <div class="panel panel-default">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                            <div class="panel-body">
                                <form  method="POST" action="javascript:;" class="form-grid-v2 FilterForm" data-base="sip" data-filter="filter">
                                    {{ csrf_field() }}
                                    <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse " role="tabpanel" aria-labelledby="headingTwo">
                            <div class="panel-body">
                                <form  method="POST" action="javascript:;" class="form-grid-v2 FilterForm" data-base="sip" data-filter="filter2">
                                    {{ csrf_field() }}
                                    <div class="row">
                                            <div class="col-md-4 col-xs-12 col-sm-4">
                                                <div class="form-group">
    ...
    <div class="x_panel">
        <div class="x_title">
            <h2>Activity Completion Report</h2>
